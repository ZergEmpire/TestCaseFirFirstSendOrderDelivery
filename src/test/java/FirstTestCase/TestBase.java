...
public class TestBase {
    ...
    private static final String ADRESS_STREET_ODINCOVO = "улица Говорова, Одинцово";
    private static final String ADRESS_HOME_ODINCOVO = "85";
    ...
    public void setUp() {
        ...
        capabilities.setCapability("videoName", "TestCaseForFirstSendOrderDelivery.mp4");
        capabilities.setCapability("name", "TestCaseForFirstSendOrderDelivery");
        ...
        try {
            driver = new RemoteWebDriver(
                    URI.create("http://192.168.1.17:4444/wd/hub").toURL(),
                    capabilities
            );
    ...
    @Step("Выбираю адрес доставки")
    public void selectAdressForDelivery(){
        $x("//input[@id = \"order_street\"]").scrollTo().setValue(ADRESS_STREET_ODINCOVO);
        $x("//input[@id = \"order_house\"]").scrollTo().setValue(ADRESS_HOME_ODINCOVO);
    }
